...
function ImgLineLong() {
  return (
    ...
    <img alt="bg" src={require("../assets/blackridgewallet.webp") } class="z-20 absolute left-[-15vw] w-[30vw] rotate-[90deg]"></img>
    <img alt="bg" src={require("../assets/ridgewallet.webp") } class="z-0 absolute left-[-13vw] w-[26vw]"></img>

    <img alt="bg" src={require("../assets/goldridgewallet.webp") } class="z-20 absolute left-[10vw]  w-[30vw] rotate-[90deg]"></img>
