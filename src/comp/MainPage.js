...
import MainCardFit from './MainCardFit'
function MainPage() {
  return (
    ...
    <div class="w-screen h-fit flex flex-col items-center">
      ...
      <div class="max-[815px]:hidden flex">
        <MainCard img={require("../assets/walletblack.png")} title={'Small Form Factor'} text={"The Swipe Wallet is made of premium metal or carbon fiber, with a small but rigid form factor that feels high-quality in your hands and will not scratch or break if dropped."}/>
        </div>
        <div class="max-[815px]:flex hidden">
        <Card 
          img={require("../assets/walletblack.png")}
      ...
      <Card 
           img={require("../assets/walletgreen.png")}
      ...
      <Card 
          img={require("../assets/bluew-removebg-preview.png")} 
      ...
      <div class="max-[815px]:hidden flex max-[815px]:mt-[5vw] mgrid ">
        <MainCardFit title={"Airtag Holder"} text={"On select models, Swipe Wallet offers an airtag holder to ensure that you will never lose your wallet again. These wallets come with different styling while maintaining all of the features that the standard Swipe Wallet comes with."} img={require("../assets/findwallet.webp")}/>
      </div>
      <div class="max-[815px]:flex hidden  max-[815px]:mt-[5vw] mgrid ">
        <Card 
          img={require("../assets/findwallet.webp")}
    ...
    {/* <img src={require("../assets/sale.jpg")} class="w-screen z-[-10] fixed"></img>
    <div class="w-screen h-screen flex bg-transparent"> 
      <span class="text-red-700 font-nun font-bold tex-2xl">
        UP TO 50% OFF
      </span>
      <span class="text-white font-nun text-8xl">
        HOLIDAY SALE
      </span>
    </div> */}
    <div class="mt-72 justify-center w-[70vw] flex flex-col">
      <span class="font-nun text-5xl max-sm:text-3xl max-sm:font-semibold font-bold text-center text-white">
      Which Swipe Wallet is right for you?
      </span>
      <div id="bottom" class="max-[815px]:flex max-[815px]:flex-col max-[815px]:items-center min-[815px]:productcol">
        <ProductCart
    ...
    <div class="w-screen flex flex-col items-center justify-evenly h-24 outline outline-1 outline-[#bababa] mt-16 ">

    <ul class="flex flex-row" role="list"><li class="list-payment__item mx-1 my-1">
    <svg class="icon icon--full-color" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24" aria-labelledby="pi-american_express">
                    <title id="pi-american_express">American Express</title>
                    <g fill="none">
                      <path fill="#FFF" d="M35,0 L3,0 C1.3,0 0,1.3 0,3 L0,21 C0,22.7 1.4,24 3,24 L35,24 C36.7,24 38,22.7 38,21 L38,3 C38,1.3 36.6,0 35,0 Z" opacity=".07"></path>
          ...
          <span class="font-nun text-xs text-gray-400">
          © 2022, SwipeWallet Powered by Shopify
          </span>
