...
function MainCard({title, text, img}) {
  return (
    ...
    <div class="rounded-3xl  bg-gradient-to-bl to-[#f2f5fc] via-[#ededed] from-white w-[96vw] max-w-[90rem] relative flex flex-row items-start justify-between max-h-[30rem] overflow-hidden h-fit min-h-[30rem] max-lg:min-h-[20rem]">
